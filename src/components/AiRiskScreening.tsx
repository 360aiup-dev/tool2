...
*提示：請務必諮詢當地勞動法律顧問以確保合規*`;
    ...
    // Default: Comprehensive Fortune 500 Strategic HRBP Analysis
    return `# 企業勞資戰略診斷報告

### 1. 現況剖析與商業打擊
貴司（${ind}，規模約 ${sz}）所遇情境：「${iss.slice(0, 50)}...」
從策略人資視角來看，這表面上是日常管理摩擦，本質上反映了**「制度未法制化」與「管理邊界模糊」的深層危機**。
- **組織動能受損**：模糊的管理界限會迅速削弱高績效人員的敬業度，讓平庸同仁產生搭便車心態，嚴重阻礙公司人才密度的拉升。
- **法律財務曝險**：勞動法規具有強制性與追溯性，管理制度上的任何破綻，在發生勞資糾紛或勞檢時都會直接轉化為經營利潤的現金流流失。
...
| 法源依據 | 潛在違規行為 | 預估財務風險/罰鍰 |
| :--- | :--- | :--- |
| **勞基法第70條** | 未依法訂立工作規則，或工作規則未報請主管機關核備公開揭示 | 處 NT$ 2萬 ～ 30萬元罰鍰 |
| **勞基法第22條第2項** | 工資未全額直接給付，或以違規罰款名義私自自薪資中扣抵 | 處 NT$ 9萬 ～ 45萬元罰鍰，並令限期補發 |
| **勞動事件法第37條** | 出勤記錄或工資給付舉證責任倒置 (推定有利於勞工) | 雇主若無健全書面留痕，在勞動法庭上面臨全盤敗訴風險 |

### 4. 策略總監實戰方案 (Action Plan)
- **全面盤點並修訂工作規則與勞動契約**：將日常作業規範轉化為具備法律約束力的條款，送交勞動局核備，建立制度權威。
- **建構勞務對價與績效激勵之薪酬防火牆**：重整薪資科目，精準切割經常性給與，合法控管二代健保、勞健保及退休金之提撥成本。
- **落實「管理行為書面留痕化」SOP**：凡涉及調動、懲戒、獎勵或請假，全面導入標準表單與簽核流程，讓法規防禦融入日常運作。
- **預約專業顧問進行全盤勞資合規體檢**：透過第三方專業視角，掃除隱藏在組織各角落的未爆彈。

### 5. 總監策略心法
**「高階主管負責打仗拓展版圖，而完善的勞動法規體系就是保住戰果的護城河。」** 越早完成合規閉環，企業規模化擴張時越無後顧之憂。
